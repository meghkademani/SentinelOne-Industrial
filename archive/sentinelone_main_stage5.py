...
try:
    while True:
        ...
        # =====================================================
        # STAGE 5 - RECENT SAFETY EVENTS PANEL
        # =====================================================
        ...
        if not recent_events:
            ...
            for timestamp, event_status, reason in recent_events:
                ...
                short_reason = reason
                if len(short_reason) > 31:
                    short_reason = short_reason[:28] + "..."

                cv2.putText(
                    frame,
                    f"{timestamp}  {event_status}",
                    (history_x1 + 12, row_y),
                    cv2.FONT_HERSHEY_SIMPLEX,
                    0.40,
                    history_color,
